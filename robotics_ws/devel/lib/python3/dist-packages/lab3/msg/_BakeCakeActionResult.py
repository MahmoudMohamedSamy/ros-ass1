...
"""autogenerated by genpy from lab3/BakeCakeActionResult.msg. Do not edit."""
import codecs
import sys
...
class BakeCakeActionResult(genpy.Message):
  ...
  _type = "lab3/BakeCakeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab3/BakeCakeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = lab3.msg.BakeCakeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lab3.msg.BakeCakeResult()
