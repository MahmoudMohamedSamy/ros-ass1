...
"""autogenerated by genpy from Assg1/BakeCakeActionResult.msg. Do not edit."""
import codecs
import sys
...
class BakeCakeActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "Assg1/BakeCakeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','Assg1/BakeCakeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BakeCakeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = Assg1.msg.BakeCakeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = Assg1.msg.BakeCakeResult()
