...
let BakeCakeFeedback = require('./BakeCakeFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BakeCakeActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new BakeCakeFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BakeCakeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BakeCakeActionFeedback(null);
    ...
    data.feedback = BakeCakeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BakeCakeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BakeCakeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BakeCakeFeedback()
    }
...
module.exports = BakeCakeActionFeedback;
