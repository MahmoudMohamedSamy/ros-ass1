...
(cl:defmethod cl:initialize-instance :after ((m <Wish-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wish-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Assg1-srv:<Wish-request> is deprecated: use Assg1-srv:Wish-request instead.")))

(cl:ensure-generic-function 'Age-val :lambda-list '(m))
(cl:defmethod Age-val ((m <Wish-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Assg1-srv:Age-val is deprecated.  Use Assg1-srv:Age instead.")
  (Age m))
...
(cl:defmethod cl:initialize-instance :after ((m <Wish-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wish-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Assg1-srv:<Wish-response> is deprecated: use Assg1-srv:Wish-response instead.")))

(cl:ensure-generic-function 'Birthday_wish-val :lambda-list '(m))
(cl:defmethod Birthday_wish-val ((m <Wish-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Assg1-srv:Birthday_wish-val is deprecated.  Use Assg1-srv:Birthday_wish instead.")
  (Birthday_wish m))
